...
/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unused-vars -- vendored: upstream fluid-sim code, reviewed as-is; exceptions die if the file is rewritten */
