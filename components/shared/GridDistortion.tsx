...
export function GridDistortion({ grid = 15, mouse = 0.1, strength = 0.15, relaxation = 0.9, imageSrc, className = "" }: GridDistortionProps) {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (!(texData instanceof Float32Array)) return;
